...
;; (let [[a b c] [[-0.04087 0.525 -0.03766732] [0.9591300003230572 0.5249999761581421 -0.03766731917858124] [-0.040869999676942825 0.5249999761581421 0.9623326808214188]]
;;       [a b c] [[0.0 0.3 0.275] [1.0 0.30000001192092896 0.2750000059604645] [0.0 -0.699999988079071 0.2750000059604645]]

;;       offset [0 0 0.01]
;;       ]
;;   (set-thing! [:background-meshes :cube]
;;               (create-cube-mesh (vector-add c offset) [1 0 0 0] 0.05 :blue))
;;   (redraw!)))
